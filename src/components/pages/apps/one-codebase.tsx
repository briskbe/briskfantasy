 ...
 * hairlines. Each column starts with its benefit and supporting explanation.
 */
      ...
      <div className="container-x">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-end lg:gap-10">
          <div className="lg:col-span-6">
            <Reveal>
              <Eyebrow>{t("codebase.eyebrow")}</Eyebrow>
            </Reveal>
            <Reveal delay={0.08}>
        ...
        <RevealGroup as="ul" className="mt-16 grid border-t border-line md:grid-cols-3 lg:mt-20" stagger={0.1}>
          {ITEMS.map((k) => (
            ...
            >
              <h3 className="text-h3 max-w-[14ch] text-balance">{t(`codebase.items.${k}.title`)}</h3>
