                ...
                <div className="sm:col-start-2 lg:col-span-4 lg:col-start-9 lg:pt-1">
                  ...
                  <ul className="mt-5 flex flex-wrap gap-2" aria-label={t("build.tagsLabel", { title: t(`build.items.${k}.title`) })}>
                    {TAGS.map((tk) => (
                      <li
                        key={tk}
                        className="rounded-full border border-line-2 px-3 py-1.5 font-mono text-[0.72rem] uppercase tracking-[0.14em] text-fg-2 transition-colors duration-500 group-hover:border-fg/40"
                      >
