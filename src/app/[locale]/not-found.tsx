...
export default function NotFound() {
  ...
  return (
    <section className="container-x section-y min-h-[70vh] flex flex-col justify-end">
      ...
      <Link href="/" className="mt-10 inline-flex items-center gap-3 text-fg underline underline-offset-8 decoration-line-2 hover:decoration-accent transition-colors">
        {t("notFound.cta")}
      </Link>
    </section>
  );
